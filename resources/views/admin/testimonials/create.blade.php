<x-app-layout>
    <x-slot name="header">
        <h2 class="font-display text-xl font-bold tracking-[-0.01em] text-ywc-ink">Ajouter un témoignage</h2>
    </x-slot>

    <div>
        <div class="max-w-3xl mx-auto">
            <form method="POST" action="{{ route('admin.testimonials.store') }}" class="rounded-2xl border border-ywc-border bg-white p-6 space-y-6">
                @csrf
